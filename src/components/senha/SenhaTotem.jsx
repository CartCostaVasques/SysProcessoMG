      ...
      <div style={{
        ...
        {setores.slice(0, 8).map(setor => (
          <button key={setor.id} onClick={() => onEscolher(setor)}
            ...
            {setor.descricao && (
              <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-evenly', alignSelf: 'stretch', borderLeft: '1px solid rgba(251,191,36,0.2)', paddingLeft: 28, marginLeft: 20 }}>
